...
const KuitansiDetail = () => {
  ...
  const { fields: fisikFields } = useFieldArray({
    name: "jasa_fisik",
    control: control,
  });
  const { fields: lainFields } = useFieldArray({
    name: "jasa_lain",
    control: control,
  });
  const { fields: perjadinFields } = useFieldArray({
    name: "perjadin_detil",
    control: control,
  });
    ...
    <>
      ...
      <form>
        <Card className="card-one">
          ...
          <Row className="d-flex justify-content-end mx-4 mb-4">
            <Col className="d-flex" style={{ columnGap: "4px" }}>
              <Button
                className="btn btn-primary"
                onClick={() => navigate("/kuitansi")}
              >
                Lihat Kuitansi
              </Button>
              <Link className="btn btn-primary" to={"/kuitansi"}>
                Simpan
              </Link>
            </Col>
          </Row>
